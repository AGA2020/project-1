...
NDefines.NGame.GAME_SPEED_SECONDS = { 1000.0, 0.25, 0.19, 0.06, 0.00 } 
...
-- 1.18 uses updated map shaders. The old performance-oriented graphics defines below
-- caused hard dark seams around sea regions, so keep graphics on vanilla values.
